        ...
        <div>
            <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 bg-gray-900 text-white ">
                <div className="max-w-xl mb-10 sm:text-center lg:max-w-2xl md:mb-20 ">
                    ...
                    <div className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-white sm:text-5xl text-start ">
                    ...
                    <p className="text-start text-white md:text-lg">

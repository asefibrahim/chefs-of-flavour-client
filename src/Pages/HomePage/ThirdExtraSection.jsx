    ...
    return (
        <div>
            ...
            <section class="bg-black
             dark:bg-gray-900">
                <div class="max-w-7xl px-6 pb-16 mx-auto">
                    ...
                    <main class="relative z-20 w-full mt-8 md:flex md:items-center xl:mt-12">
                        ...
                        <div class="w-full p-6 bg-gray-800 md:flex md:items-center rounded-2xl md:bg-transparent md:p-0 lg:px-12 md:justify-evenly">
                            ...
                            <div class="mt-2 md:mx-6">
                                ...
                                <div class="flex items-center justify-between mt-6 md:justify-start">
                                    <button title="left arrow" class="p-2 text-gray-300 transition-colors duration-300 border rounded-full rtl:-scale-x-100 hover:bg-purple-400">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7" />
                                        </svg>
                                    </button>

                                    <button title="right arrow" class="p-2 text-gray-300 transition-colors duration-300 border rounded-full rtl:-scale-x-100 md:mx-6 hover:bg-purple-400">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">

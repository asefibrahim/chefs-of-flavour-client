            ...
            <section class="bg-black
             dark:bg-gray-900">
                <div class="max-w-6xl px-6 pb-16 mx-auto">
                    ...
                    <h1 class="mt-2 text-2xl font-semibold text-gray-300 capitalize lg:text-3xl dark:text-white">
                    ...
                    <main class="relative z-20 w-full mt-8 md:flex md:items-center xl:mt-12">
                        ...
                        <div class="w-full p-6 bg-blue-600 md:flex md:items-center rounded-2xl md:bg-transparent md:p-0 lg:px-12 md:justify-evenly">
                            ...
                            <div class="mt-2 md:mx-6">
                                <div>
                                    <p class="text-xl font-medium tracking-tight text-white">Enrique Olvera </p>
                                    <p class="text-blue-200 ">Chief  chef at Stech</p>
                                </div>

                                <p class="mt-4 text-lg leading-relaxed text-white md:text-xl"> “Cooking is all about people. Food is maybe the only universal thing that really has the power to bring everyone together. No matter what culture, everywhere around the world, people get together to eat.” <br /> <br /> - Enrique Olvera </p>

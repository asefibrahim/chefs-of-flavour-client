...
const Banner = () => {
    return (
        <div
        >
            <section class="dark:bg-gray-900  md:pt-5 md:px-2 bg-black ">
                <div class="container px-6 py-10 mx-auto">
                    <div class="lg:flex lg:items-center">
                        <div class="w-full space-y-12 lg:w-1/2 ">
                            <div>
                                <h1 class="text-2xl font-semibold capitalize lg:text-4xl text-gray-300 "><span className='text-purple-500 text-7xl '>Explore</span>

                                    <p className='my-4 text-5xl'>Our Chiefs  with</p>
                                    <span className='text-purple-500 text-5xl '>great recipes</span></h1>
                            ...
                            <div class="md:flex md:items-start md:-mx-4">
                                <span class="inline-block p-2 text-purple-500 bg-blue-100 rounded-xl md:mx-4 dark:text-gray-300 dark:bg-blue-500">
                                ...
                                <div class="mt-4 md:mx-4 md:mt-0">
                                    <h1 class="text-xl font-semibold  capitalize text-gray-300">
                                        FRESH TASTE</h1>

                                    <p class="mt-3 text-gray-400 font-semibold ">
                                        Fruits and vegetables: Fresh fruits and vegetables should be firm, free of bruises or cuts, and have vibrant colors. They should also have a fresh, natural scent. You can also try gently squeezing the produce to see if it feels firm or soft. If it is too soft, it may be overripe.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="md:flex md:items-start md:-mx-4">
                                ...
                                <div class="mt-4 md:mx-4 md:mt-0">
                                    <h1 class="text-xl font-semibold text-gray-300capitalize text-gray-300">
                                        MADE WITH LOVE</h1>

                                    <p class="mt-3 text-gray-400 font-semibold dark:text-gray-300">
                                        Our Cooks are  passionate about cooking and that they take pride in creating dishes that are both tasty and nutritious. It can also imply that the food has been prepared with positive intentions, such as wishing to nourish and delight those who will consume it.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="md:flex md:items-start md:-mx-4">
                                ...
                                <div class="mt-4 md:mx-4 md:mt-0">
                                    <h1 class="text-xl font-semibold capitalize text-gray-300">
                                        ...
                                        TASTE THE DIFFERENCE</h1>

                                    <p class="mt-3 text-gray-400 font-semibold dark:text-gray-300">
                                        Characteristics of flavor, texture, and aroma that are present in a particular food. Taste is a subjective experience, and what is considered good or bad can vary depending on an individual's preferences and cultural background. However, there are some general factors that can influence the quality of food taste
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="hidden lg:flex lg:items-center lg:w-1/2 lg:justify-center">
                            <img class="w-[30rem] h-[30rem] object-cover xl:w-[34rem] xl:h-[34rem] rounded-full  " src="https://images.unsplash.com/photo-1620641606872-f9641b65adab?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80" alt="" />
                        </div>
                    </div>

                ...
                <div class="container px-6 py-10 mx-auto">
                    <div class="lg:flex lg:items-center">
                        <div class="w-full space-y-12 lg:w-1/2 ">
                            <div>
                                <h1 class="text-2xl font-semibold capitalize lg:text-4xl text-white "><span className='text-purple-500 text-7xl '>Explore</span>
                            ...
                            <div class="md:flex md:items-start md:-mx-4">
                                <span class="inline-block p-2 text-purple-500 bg-blue-100 rounded-xl md:mx-4 dark:text-white dark:bg-blue-500">
                            ...
                            <div class="md:flex md:items-start md:-mx-4">
                                ...
                                <div class="mt-4 md:mx-4 md:mt-0">
                                    <h1 class="text-xl font-semibold text-gray-300capitalize text-white">
                                        MADE WITH LOVE</h1>

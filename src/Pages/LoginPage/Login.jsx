                ...
                <div class="flex items-center justify-center w-full h-full    absolute inset-0 bg-black/60 ">
                   ...
                   */}
                    ...
                    <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
                        ...
                        <p class="mt-3 text-xl text-center text-gray-200 dark:text-gray-200">
                            Welcome back!
                        </p>

                        <a href="#" class="flex items-center justify-center mt-4 text-gray-200 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-800 hover:bg-gray-800 dark:hover:bg-gray-600">
                            <div class="px-4 py-2">
                            ...
                            <span class="w-5/6 px-4 py-3 font-bold text-center">Login in with Google</span>
                        </a>
                        <a href="#" class="flex items-center justify-center mt-4 text-gray-200 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-800 hover:bg-gray-800 dark:hover:bg-gray-600">
                            <div class="px-4 py-2">
                        ...
                        <div class="flex items-center justify-between mt-4">
                            ...
                            <a href="#" class="text-xs text-center text-gray-200 uppercase dark:text-gray-400 hover:underline">or login
                                with email</a>
